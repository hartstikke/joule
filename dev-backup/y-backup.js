...
<!--most recent chatbot - START-->
<script>
Chathive.widget.init({apiKey: "YyXkHMHwajGaYdrRGkyn2QCd"});
Chathive.widget.setLanguage("nl");
</script>
<!-- most recent chatbot - END -->
...
function fietsgidsButtonWerkgever1(lang) {
    if (document.getElementById('fietsgids-button-werkgever-1')) {
        var fietsgidsButtonWrapper = document.getElementById('fietsgids-button-werkgever-1')
        if (lang === 'nl') {
...
function fietsgidsButtonWerkgever2(lang) {
    if (document.getElementById('fietsgids-button-werkgever-2')) {
        var fietsgidsButtonWrapper = document.getElementById('fietsgids-button-werkgever-2')
        if (lang === 'nl') {
            fietsgidsButtonWrapper.href = "https://blog.joule.be/financiele-gids-fietsleasing"
            return
        } else if (lang === 'en') {
...
function fietsgidsButtonWerkgever3(lang) {
    if (document.getElementById('fietsgids-button-werkgever-3')) {
        var fietsgidsButtonWrapper = document.getElementById('fietsgids-button-werkgever-3')
        if (lang === 'nl') {
            fietsgidsButtonWrapper.href = "https://blog.joule.be/financiele-gids-fietsleasing"
            return
        } else if (lang === 'en') {
...
function fietsgidsButtonOverheid1(lang) {
    if (document.getElementById('fietsgids-button-overheid-1')) {
        var fietsgidsButtonWrapper = document.getElementById('fietsgids-button-overheid-1')
        if (lang === 'nl') {
            fietsgidsButtonWrapper.href = "https://blog.joule.be/financiele-gids-fietsleasing"
            return
        } else if (lang === 'en') {
...
function fietsgidsButtonOverheid2(lang) {
    if (document.getElementById('fietsgids-button-overheid-2')) {
        var fietsgidsButtonWrapper = document.getElementById('fietsgids-button-overheid-2')
        if (lang === 'nl') {
            fietsgidsButtonWrapper.href = "https://blog.joule.be/financiele-gids-fietsleasing"
            return
        } else if (lang === 'en') {
